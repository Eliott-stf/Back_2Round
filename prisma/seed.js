...
async function main() {
    ...
    const usersData = [
        { name: 'John', lastname: 'Doe', email: 'john@test.com', password: hashedPassword, role: 'USER', boxingType: 'Muay Thai', weight: 75, height: 180 },
        { name: 'Mike', lastname: 'Tyson', email: 'mike@2round.com', password: hashedPassword, role: 'USER', boxingType: 'Boxe Anglaise', weight: 95, height: 178 },
        { name: 'Admin', lastname: 'Boxing', email: 'admin@2round.com', password: hashedPassword, role: 'ADMIN', boxingType: 'Savate', weight: 80, height: 185 },
        { name: 'Sarah', lastname: 'Connor', email: 'sarah@test.com', password: hashedPassword, role: 'USER', boxingType: 'Kickboxing', weight: 62, height: 170 },
        { name: 'Tony', lastname: 'Montana', email: 'tony@test.com', password: hashedPassword, role: 'USER', boxingType: 'Boxe Anglaise', weight: 81, height: 175 },
        { name: 'Ali', lastname: 'Clay', email: 'ali@test.com', password: hashedPassword, role: 'USER', boxingType: 'Boxe Anglaise', weight: 98, height: 191 },
        { name: 'Leila', lastname: 'Amara', email: 'leila@test.com', password: hashedPassword, role: 'USER', boxingType: 'Krav Maga', weight: 55, height: 165 },
    ];
    const createdUsers = [];
