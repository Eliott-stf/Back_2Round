import { IsBoolean, IsOptional, IsString, MinLength, MaxLength, Matches, IsNotEmpty } from 'class-validator';

export class CreateBankAccountDto {
  @IsNotEmpty({ message: 'Veuillez renseigner un IBAN valide.' })
  ...
  @IsNotEmpty({ message: 'Veuillez renseigner un BIC valide.' })
  ...
  @IsNotEmpty({ message: 'Veuillez renseigner un nom de titulaire valide.' })
